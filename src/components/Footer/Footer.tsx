...
export const Footer = () => {
    return <footer className='Footer'>
        <ul className="Footer__content">
            <li><a href="https://www.facebook.com/kristina.chychkovska" target="_blank">
                <i className="icon-facebook-official"/></a></li>
            <li><a href="https://www.instagram.com/kristinychh/" target="_blank">
                <i className="icon-instagram"/></a></li>
            {/*   <li><a href="" target="_blank"><i className="icon-linkedin-squared"/></a></li>*/}
            <li><a href="https://www.behance.net/vernalbloom1" target="_blank">
